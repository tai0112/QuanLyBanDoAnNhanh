...
namespace Fastfood
{
    public partial class frmHoaDon : Form
    {
        ...
        {
            //Nút Export to Excel
            // creating Excel Application  _ Tạo ứng dụng Excel
            ...
            //Đổi tên Sheet thành Exported from Data gridview
            ...
            //Lưu file .Xlsx
            workbook.SaveAs("D:\\Fastfood\\output.xlsx", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
            //Thoát khỏi Excel  
            app.Quit();
        }
    }
